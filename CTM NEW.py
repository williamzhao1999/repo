...
G.add_nodes_from([
                ...
                ("D6", {"label": "D6", "index":8}),
                ("D7", {"label": "D7", "index":9}),
                ("D8", {"label": "D8", "index":10}),
                ("D9", {"label": "D9", "index":11}),
                ("D10", {"label": "D10", "index":12}),
                ])
...
attrs = {
            ...
            ("O2", "D5"): {"label":1,"type_upstream_connection":"entering", "type_downstream_connection": "diverging"},
            ("O1", "O3"): {"label":2,"type_upstream_connection":"entering", "type_downstream_connection": "diverging"},
            ("O1", "D4"): {"label":3,"type_upstream_connection":"entering", "type_downstream_connection": "diverging"},
            ("D4", "D5"): {"label":4,"type_upstream_connection":"merging", "type_downstream_connection": "diverging"},
            ("D4", "D7"): {"label":5,"type_upstream_connection":"merging", "type_downstream_connection": "diverging"},
            ("D5", "D6"): {"label":6,"type_upstream_connection":"merging", "type_downstream_connection": "diverging"},
            ("D5", "D10"): {"label":7,"type_upstream_connection":"merging", "type_downstream_connection": "diverging"},
            ("O3", "D7"): {"label":8,"type_upstream_connection":"merging", "type_downstream_connection": "diverging"}, 
            ("D7", "D6"): {"label":9,"type_upstream_connection":"merging", "type_downstream_connection": "diverging"},
            ("O3", "D3"): {"label":10,"type_upstream_connection":"merging", "type_downstream_connection": "diverging"},
            ("D7", "D8"): {"label":11,"type_upstream_connection":"merging", "type_downstream_connection": "diverging"},
            ("D6", "D9"): {"label":12,"type_upstream_connection":"merging", "type_downstream_connection": "diverging"},
            ("D10", "D2"): {"label":13,"type_upstream_connection":"ordinary", "type_downstream_connection": "exiting"},
            ("D8", "D3"): {"label":14,"type_upstream_connection":"ordinary", "type_downstream_connection": "diverging"},
            ("D8", "D9"): {"label":15,"type_upstream_connection":"ordinary", "type_downstream_connection": "diverging"},
            ("D9", "D1"): {"label":16,"type_upstream_connection":"merging", "type_downstream_connection": "exiting"},
            ("D9", "D2"): {"label":17,"type_upstream_connection":"merging", "type_downstream_connection": "exiting"},
            ("D3", "D1"): {"label":18,"type_upstream_connection":"merging", "type_downstream_connection": "exiting"},
...
paths = [
    ...
    [("O2","D4"), ("D4", "D5"), ("D5","D6")],
    # (2) Viola
    [("O2", "D4"), ("D4", "D7"), ("D7", "D8"), ("D8", "D3"), ("D3", "D1")],
    # (3) Rose
    [("O2", "D4")],
    # (4) Sky blue
    [("O2", "D4"), ("D4", "D7"), ("D7", "D8"), ("D8", "D9"), ("D9", "D1")],
    # (5) Gray
    [("O2", "D4"), ("D4", "D5")],
    # (6) Light Green
    [("O2", "D5"), ("D5", "D6"), ("D6", "D9")],
    ...
    [("O1", "O3"), ("O3", "D3"), ("D3", "D1")],
    # (14) Gold
    [("O1", "O3"), ("O3", "D7"), ("D7", "D8"), ("D8", "D3"), ("D3", "D1")],
    # (15) Dark Orange
    [("O1", "O3"), ("O3", "D7"), ("D7", "D6"), ("D6", "D9"), ("D9", "D1")],
    # (16) Red
    [("O1", "O3"), ("O3", "D7"), ("D7", "D6"), ("D6", "D9"), ("D9", "D2")],
    # (17) Dark Red
    [("O1", "D4"), ("D4", "D5"), ("D5", "D6"), ("D6", "D9")],
    # (18) Fucsia
    [("O1", "D4"), ("D4", "D7"), ("D7","D8"), ("D8", "D3")],
    # (19) Yellow
    [("O1", "D4"), ("D4", "D5"), ("D5", "D6"), ("D6", "D9"), ("D9", "D1")],
    # (20) Light Green
    [("O1", "D4"), ("D4", "D7"), ("D7", "D8")],
    # (21) Dark Green
    [("O1", "D4"), ("D4", "D5"), ("D5", "D10"), ("D10", "D2")],
    # (22) Rose Skin
    [("O1", "D4"), ("D4", "D7"), ("D7", "D8"), ("D8", "D3"), ("D3", "D1")],
    # (23) Light Blue
    [("O3", "D7"), ("D7", "D8"), ("D8", "D3")],
    # (24) Bright Blue
    [("O3", "D7")] 
...
lambdas_rates =  [50, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 55, 50, 45, 40, 35, 30, 25, 20, 15, 10, 5, 20]
