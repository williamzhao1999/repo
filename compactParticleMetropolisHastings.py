...
def particleFilter(observations, parameters, noParticles, initialState, particleProposalDistribution, observationProposalDistribution):
    ...
    for t in range(1, noObservations):
        ...
        particles[:, t] = particleProposalDistribution(t, particles[newAncestors,:], parameters, noParticles)

        # Compute weights
        weights[:, t] = observationProposalDistribution(t, observations, particles)
